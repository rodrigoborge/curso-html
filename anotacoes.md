...
@font-face {
    font-family: 'Chicken';
    src: url(fontes/ChickenSoup.otf); format('opentype'), url(fontes/ChickenSoup.otf) format('truetype')
</code>
</pre>
...
<li>opentype → otf</li>
<li>opentype → ttf</li>
<li>embed-opentype</li>
<li>truetype-aat → Apple Advanced Typography</li>
<li>svg</li>
